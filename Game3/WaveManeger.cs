...
namespace Game3
{
    class WaveManeger
    {
        ...
        public WaveManeger(Level level, int numberOfWaves, Texture2D enemyTexture)
        {
            ...
            {
                int initialNumerOfEnemies = 6;//set number of enemie
                int numberModifier = (i / 6) + 1;

                Wave wave = new Wave(i+1, initialNumerOfEnemies *
